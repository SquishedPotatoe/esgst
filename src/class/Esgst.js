	...
	constructor() {
		...
		this.paths = {
			sg: [
				...
				{ name: 'Discussions - Add-ons / Tools', pattern: '^/discussions/addons-tools' },
				...
				{ name: 'Discussions - Game Showcase', pattern: '^/discussions/game-showcase' },
				...
				{ name: 'My Discussions - Bookmarked', pattern: '^/discussions/bookmarked' },
				...
				{ name: 'User - Giveaways - Sent', pattern: `^/user/\\w+?($|/search)` },
				{ name: 'User - Giveaways - Won', pattern: '^/user/\\w+?/giveaways/won' },
